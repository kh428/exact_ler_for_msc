# Adapted from kh428/accel-cutting-magic-state, stab_rank_cut.py.
# Licensed under Apache-2.0; see licenses/accel-cutting-Apache-2.0.txt.
"""
...
def cut_spider(g: BaseGraph, v: VertexId) -> Tuple[BaseGraph, BaseGraph]:
    ...
    # Preserve vertex IDs and parameter sets in each branch.
    g_left = deepcopy(g)
    g_right = deepcopy(g)
